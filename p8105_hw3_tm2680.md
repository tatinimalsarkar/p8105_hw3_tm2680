...
Here is my spaghetti plot showing the number of observations across time for the `brfss_data` dataset. The colors correspond to state, and the data is from 2002 to 2010.
